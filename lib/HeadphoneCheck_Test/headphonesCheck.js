...
class HeadphonesCheck {
  ...
  constructor(settings = {}) {
    ...
    this._settings = {
      callback: undefined,
      volumeSound: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/audio_test.mp3',
      volumeText: '',
      checkType: 'huggins',
      checkVolume: 1,
      checkExample: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_example_2.mp3',
      checkSounds: [{
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set1_2.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set1_1.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set1_3.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set2_1.mp3'
      }, {
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set2_2.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set2_3.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set3_1.mp3'
      }, {
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set3_2.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set3_3.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set4_1.mp3'
      }, {
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set4_2.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set4_3.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set5_1.mp3'
      }, {
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set5_2.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set5_3.mp3'
      }, {
        answer: 1,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set6_1.mp3'
      }, {
        answer: 2,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set6_2.mp3'
      }, {
        answer: 3,
        file: './lib/HeadphoneCheck_Test/stimuli_HugginsPitch/HugginsPitch_set6_3.mp3'
      }],
      trialCount: 6,
      passMark: 6,
      maxAttempts: 2
  ...
  _adjustVolume() {
    const html = '<p class="notice">Please put on your headphones and lower your volume to around 10%.</p>' + '<p>If you do not have headphones, you can use earbuds (headphones are preferred).</p>' + '<p>Click the <span style="color:#03a9f4;"><b>blue</b></span> button below to play a sound to check your volume. Gradually increase your volume until you can comfortably make out the words being spoken. ' + this._settings.volumeText + '</p>' + '<div class="notice">' + '<button type="button" data-helper-button data-headphones-audio-control data-headphones-audio-group="group1" disabled>Loading sounds...</button>' + '<audio data-headphones-audio-group="group1" data-headphones-volume="1" preload="auto" loop><source src="' + this._settings.volumeSound + '">' + this.htmlElements.audioProblem + '</audio>' + '</div>' + '<p>If you do not adjust your volume correctly, you will not be able to successfully complete the study, and the study may stop before completion. Once adjusted, keep this volume level for the rest of the experiment.</p>';

    const promise = this._createDialog({
      content: html,
  ...
  _instruction() {
    let html = this.htmlElements[this._settings.checkType].instruction + '<p class="notice">Remember, from now on, you can only play each sound once.<br>Please listen carefully and choose your answer.</p>' + '<p class="notice">Are you ready?</p>';
  ...
  _performCheck() {
    let html = this.htmlElements[this._settings.checkType].checkPage + '<div class="center" data-headphones-check-target></div>' + '<hr><div data-headphones-progress><span></span></div>';
  ...
  _trialHandler(remaining, current = 0) {
    ...
    this._createTrial(trialData.file).then(response => {
          ...
          $('button[data-headphones-audio-control]').html('<img alt="Play" src="data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 31.7 31.9\'%3E%3Cpath d=\'M8.6,0.5C6.8-0.6,5.2,0.2,5.2,2.4v27c0,2.2,1.5,3.1,3.4,1.9L30.3,18c1.9-1.2,1.9-3,0-4.2L8.6,0.5z\' fill=\'%2303A9F4\'/%3E%3C/svg%3E">').prop('disabled', false).on('click', function () {
            ...
            audioElements.on('ended', () => {
              ...
              $('button[data-headphones-check-response]').prop('disabled', false).on('click', function () {
                ...
                $('button:contains("continue")').prop('disabled', false).on('click', () => {
